...
# Título de la página
st.title("Consultas sobre Impuesto de Renta")

# Descripción de la página
st.markdown("""
Esta sección le permite realizar consultas específicas sobre el Impuesto de Renta en Colombia.
La base de conocimiento incluye conceptos de la Dian sobre renta desde 2017 hasta 2024. Contiene 1702 conceptos de la Dian sobre renta.
        ...
        if index_name not in existing_indexes:
            ...
            if query:
                ...
                with st.chat_message("assistant"):
                    ...
                    # CAMBIO IMPORTANTE: Consultar directamente a Pinecone con reranking
                    try:
                        ...
                        documents = retrieve_with_reranking(query, query_pinecone, top_k=8)
                        ...
                        if not documents:
                            ...
                            update_flow("✍️ Generando respuesta especializada en Renta...")
                            time.sleep(0.5)
                            ...
                            update_flow("✨ Respuesta sobre Renta generada con éxito!")
